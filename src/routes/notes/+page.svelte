...
<main class="chatHead">
    ...
    <form  method="post"
        use:enhance={({ formElement, formData, action, cancel }) => {
            ...
            <img style="width: 100px; height: 100px;" src="https://halitlar.com/aa/lib/elfinder/files//clear-men-cool-sport-menthol-shampoo-350-ml/clear-men-cool-sport-menthol-shampoo-350-ml242204713_400.jpg" alt="clear chat" on:click={()=>clearChat()}>
    </form>
</main>
